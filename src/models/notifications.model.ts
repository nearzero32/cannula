...
const notificationSchema = new Schema<NotificationDocument>(
    {
        ...
        source: { type: new Schema({ domain: { type: String, enum: ['appointment','home_care_request','pharmacy_treatment_request','patient_medication'] }, id: { type: Schema.Types.ObjectId } }, { _id: false }), default: null },
        target: { type: new Schema({ type: { type: String, enum: ['appointment','home_care_request','pharmacy_treatment_request','medication_dose'] }, id: { type: Schema.Types.ObjectId } }, { _id: false }), default: null },
