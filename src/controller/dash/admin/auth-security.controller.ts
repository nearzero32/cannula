...
export const authSecurityController = new Elysia({ prefix: '/auth-security', detail: { tags: [SWAGGER_TAGS.ADMIN.AUTH_SECURITY] } })
    ...
    }, { query: t.Object({ page: t.Optional(t.String()), limit: t.Optional(t.String()), phone: t.Optional(t.String()), flowId: t.Optional(t.String()), type: t.Optional(t.Enum(AuthEventTypeEnum)), success: t.Optional(t.Boolean()), journey: t.Optional(t.Union([t.Literal('registration'), t.Literal('login'), t.Literal('pin_recovery')])), userId: t.Optional(t.String()), patientId: t.Optional(t.String()), dateFrom: t.Optional(t.String()), dateTo: t.Optional(t.String()) }), response: { 200: GenericPaginatedResponseSchema, 403: ForbiddenResponseSchema, 422: ValidationErrorResponseSchema, ...ProtectedApiErrorResponses } })
