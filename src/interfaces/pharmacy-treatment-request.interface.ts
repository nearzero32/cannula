...
export interface IPharmacyTreatmentRequest extends IBaseDocument {
 ...
 dispatch:{status:string;mode:string;pharmacy_id?:mongoose.Types.ObjectId|null;assigned_at?:Date|null;assigned_by_user_id?:mongoose.Types.ObjectId|null;version:number}; quotation?:PharmacyQuotation|null;
 excluded_pharmacy_ids:mongoose.Types.ObjectId[]; cancelled_at?:Date|null; cancelled_by_user_id?:mongoose.Types.ObjectId|null; cancellation_reason?:string|null;
}
